...
var slideshow = (function(window, undefined) {
   ...
   */
  var slides = [
    'images/img-prj/bird-a.jpg',
    'images/img-prj/bird-b.jpg',
    'images/img-prj/bird-c.jpg',
    'images/img-prj/bird-d.jpg'
  ];
  ...
  var masks = [
    {
      source: 'images/img-prj/masks/prism-a.svg',
      effects: {
        flip: 'X',
        rotate: 45 // degrees
      }
    ...
    {
      source: 'images/img-prj/masks/prism-b.svg',
      effects: {
        flip: false,
        rotate: 45 // degrees
      }
    ...
    {
      source: 'images/img-prj/masks/prism-c.svg',
      effects: {
        flip: false,
        rotate: 180 // degrees
      }
   ...
   */
  function addEvents_() {
    // Detect click on navigation element (ul).
